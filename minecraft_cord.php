...
<head>
  ...
  <style>
    .container {
      ...
      /* Distribui o espaço de forma uniforme */
      flex-wrap: wrap;
    ...
    .addNewStructure {
      ...
      /* Garante que os blocos tenham largura apenas suficiente para o conteúdo */
    ...
    .addNewStructure form input {
      ...
      border-radius: 5px;
      width: calc(100% - 22px);
      /* Controla a largura sem ultrapassar os limites do formulário */
      max-width: 250px;
